  ...
  return (
    <div className="rounded-lg border border-gray-200 bg-white p-4">
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          <div className="flex items-center justify-between">
            ...
            <span className={`rounded-full px-2 py-0.5 text-xs font-medium ${getStatusBadge(pet.vaccinationStatus)}`}>
              {pet.vaccinationStatus === "Valid" ? "● Valid" : pet.vaccinationStatus === "Due Soon" ? "● Due Soon" : "● Overdue"}
            </span>
          </div>
          <p className="text-sm text-gray-500">{pet.breed || pet.species}</p>
          <div className="mt-1 flex items-center gap-4 text-xs text-gray-500">
            <span>Age {pet.age || "N/A"}</span>
            <span>Last Visit {pet.lastVisit || "N/A"}</span>
            {pet.rabiesStatus && (
              <span className={`rounded-full px-2 py-0.5 ${getStatusBadge(pet.rabiesStatus)}`}>
                ● {pet.rabiesStatus === "Valid" ? "Rabies" : "Rabies " + pet.rabiesStatus}
              </span>
            )}
          </div>
        </div>
      ...
      <div className="mt-3 flex gap-2">
        ...
        <button className="flex items-center gap-1 rounded-md border border-gray-300 px-3 py-1.5 text-xs font-medium text-gray-700 hover:bg-gray-50">
          Prescriptions
        </button>
      </div>
    </div>
                  ...
                  {appointments.length > 0 && (
                    <div className="mt-3 flex items-center justify-between border-t border-gray-100 pt-3">
                      ...
                      <div className="flex gap-2">
                        ...
                        <button className="rounded border border-gray-300 p-1 text-gray-500 hover:bg-gray-50">
                          <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
