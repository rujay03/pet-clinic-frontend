            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3 text-white">
                  ...
                  <a href="tel:+94112942415" className="hover:underline">
                    011 29 42 415
                  </a>
                </div>
                <div className="flex items-center gap-3 text-white">
                  ...
                  <div>
                    <a href="tel:+94712765078" className="hover:underline">
                      071 27 65 078
                    </a>
                ...
                <div className="flex items-center gap-3 text-white">
                  ...
                  <a href="mailto:mail@pawcare.com" className="hover:underline">
                    mail@pawcare.com
                  </a>
                </div>
              </div>
